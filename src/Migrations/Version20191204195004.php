...
final class Version20191204195004 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_info (id INT AUTO_INCREMENT NOT NULL, user_id_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, phone_number VARCHAR(32) NOT NULL, personal_email VARCHAR(255) NOT NULL, date_of_birth DATE NOT NULL, city LONGTEXT NOT NULL, person_code VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX idx_user_id (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_visit (id INT AUTO_INCREMENT NOT NULL, client_id_id INT NOT NULL, specialist_id_id INT NOT NULL, clinic_id_id INT NOT NULL, sending_to_doctor_id_id INT DEFAULT NULL, recipe_id_id INT DEFAULT NULL, visit_date DATETIME NOT NULL, description VARCHAR(2000) DEFAULT NULL, is_completed TINYINT(1) DEFAULT NULL, INDEX IDX_A1BC1261DC2902E0 (client_id_id), INDEX IDX_A1BC1261C6F2BC85 (specialist_id_id), INDEX IDX_A1BC1261F6C03764 (clinic_id_id), INDEX IDX_A1BC1261B55430AD (sending_to_doctor_id_id), INDEX IDX_A1BC126169574A48 (recipe_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
