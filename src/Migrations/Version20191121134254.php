 ...
 */
final class Version20191121134254 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, role INT NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_info (id INT AUTO_INCREMENT NOT NULL, user_id_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, phone_number VARCHAR(32) NOT NULL, personal_email VARCHAR(255) NOT NULL, date_of_birth DATE NOT NULL, city LONGTEXT NOT NULL, person_code VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_B1087D9E9D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_visit (id INT AUTO_INCREMENT NOT NULL, client_id_id INT NOT NULL, specialist_id_id INT NOT NULL, clinic_id_id INT NOT NULL, sending_to_doctor_id_id INT DEFAULT NULL, recipe_id_id INT DEFAULT NULL, visit_date DATETIME NOT NULL, description VARCHAR(2000) NOT NULL, is_completed TINYINT(1) DEFAULT NULL, INDEX IDX_A1BC1261DC2902E0 (client_id_id), INDEX IDX_A1BC1261C6F2BC85 (specialist_id_id), INDEX IDX_A1BC1261F6C03764 (clinic_id_id), INDEX IDX_A1BC1261B55430AD (sending_to_doctor_id_id), INDEX IDX_A1BC126169574A48 (recipe_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE clinic_specialists DROP FOREIGN KEY FK_D21A57C3F6C03764');
        $this->addSql('ALTER TABLE clinic_specialists DROP FOREIGN KEY FK_D21A57C3C6F2BC85');
        ...
        $this->addSql('ALTER TABLE clinic_work_hours DROP FOREIGN KEY FK_787EC225F6C03764');
