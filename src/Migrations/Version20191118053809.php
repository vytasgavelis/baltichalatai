 ...
 */
final class Version20191118053809 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_info CHANGE user_id_id user_id_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user_visit CHANGE sending_to_doctor_id_id sending_to_doctor_id_id INT NOT NULL, CHANGE recipe_id_id recipe_id_id INT NOT NULL, CHANGE is_completed is_completed TINYINT(1) DEFAULT \'NULL\'');
    }
}
