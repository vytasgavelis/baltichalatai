 ...
 */
final class Version20191109164719 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_info (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, phone_number VARCHAR(32) NOT NULL, personal_email VARCHAR(255) NOT NULL, date_of_birth DATE NOT NULL, address LONGTEXT NOT NULL, person_code VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_B1087D9E9D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
